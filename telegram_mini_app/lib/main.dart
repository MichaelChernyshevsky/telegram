      ...
      body: Center(
        child: Padding(
          ...
          child: Column(
            ...
            children: <Widget>[
              Text('Color Scheme: $_colorScheme', style: TextStyle(fontSize: 16)),
              SizedBox(height: 10),
              Text('Viewport Height: $_viewportHeight', style: TextStyle(fontSize: 16)),
              SizedBox(height: 10),
              Text('Init Data: $_initData', style: TextStyle(fontSize: 16)),
              SizedBox(height: 10),
              Text('Header Color: $_headerColor', style: TextStyle(fontSize: 16)),
              SizedBox(height: 20),
              ElevatedButton(
                onPressed: () {
      ...
      bottomNavigationBar: BottomAppBar(
        child: Row(
          ...
          children: <Widget>[
            TextButton(
              onPressed: () async {
                final result = await WebApp().showConfirmAsync(message: "Some message");
